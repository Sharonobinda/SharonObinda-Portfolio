...
export default function Home() {
  return (
    <section id="home" className="flex flex-col min-h-screen justify-center">
      <div className="container mx-auto flex px-10 md:flex-row flex-col items-center relative z-10 mt-[-80px]"> {/* Increased top margin */}
        {/* Text Section */}
        <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
          <h1 className="title-font sm:text-5xl text-4xl mb-4 font-bold text-white">
            ...
            <span className="text-white mt-2 text-2xl">From Nairobi, Kenya.</span>
          </h1>
